...
//    
//	/* Load a font */
//	if (FT_New_Face(ft, "/Users/tobbew92/Documents/workspace/DGIProject/thirdparty/freetype-2.5.3/font/FreeSans.ttf", 0, &face)) {
...
////		return 0;
////    
//	attribute_coord = get_attrib(vbo, "coord");
//	uniform_tex = get_uniform(vbo, "tex");
//	uniform_color = get_uniform(vbo, "color");
//    
...
//
//void DisplayText() {
//	float sx = 2.0 / float(512/2);
//	float sy = 2.0 / float(512/2);
//    
...
//    
//	//glutSwapBuffers(); glfwSwapBuffers körs i Render()
//}
//
...
////    
////	if (initFreeText()) {
////		DisplayText(); //ska anropas i typ Render() funktionen
//////		glutMainLoop();
////	}
////    
////	free_resources();
